...
class DigitalTimer extends Component {
  ...
  clearTimerInterval = () => clearInterval(this.initialId)
  ...
  renderTimerLimitController = () => {
    ...
    return (
      <div className="timer-limit-container">
        ...
        <div className="timer-limit-button">
          <button
          ...
          <div className="limit-label-value">
            <button
              className="limit-container-button"
              disabled={isButtonsDisabled}
  ...
  onStartOrPauseTimer = () => {
    ...
    if (isTimerRunning) {
      ...
      this.initialId = setInterval(this.incrementTimerElapsedInSeconds, 1000)
    }
  ...
  getElapsedSecondsInTimeFormat = () => {
    const {timerLimitInMinutes, timerElapsedInSeconds} = this.state
    const totalRemainingSeconds = timerLimitInMinutes * 60
